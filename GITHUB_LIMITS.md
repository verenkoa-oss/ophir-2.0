...
| После исчерпания лимита | Переход на базовую модель (GPT-4o mini) или сообщение "You've used all of this month's Premium requests" |
...
(GPT-4o mini), которая работает без ограничений. Или подожди начала следующего месяца.
